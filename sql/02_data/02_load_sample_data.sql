...
VALUES
    -- English Invoices
    ('INV_EN_001', 'INVOICE', '@SNOWFLAKE_EXAMPLE.SWIFTCLAW.DOCUMENT_STAGE', 'generated/invoice_en_001.pdf', 'invoice_en_001.pdf', 'PDF', 4500, 'en', 'PENDING',
     PARSE_JSON('{"vendor_name": "Acme Production Services", "invoice_number": "INV-2024-0001", "currency": "USD", "generated_for_demo": true}')),
    ('INV_EN_002', 'INVOICE', '@SNOWFLAKE_EXAMPLE.SWIFTCLAW.DOCUMENT_STAGE', 'generated/invoice_en_002.pdf', 'invoice_en_002.pdf', 'PDF', 4600, 'en', 'PENDING',
     PARSE_JSON('{"vendor_name": "Acme Production Services", "invoice_number": "INV-2024-0002", "currency": "USD", "generated_for_demo": true}')),
    -- Spanish Invoices
    ('INV_ES_003', 'INVOICE', '@SNOWFLAKE_EXAMPLE.SWIFTCLAW.DOCUMENT_STAGE', 'generated/invoice_es_003.pdf', 'invoice_es_003.pdf', 'PDF', 4700, 'es', 'PENDING',
     PARSE_JSON('{"vendor_name": "Servicios de Produccion Acme", "invoice_number": "INV-2024-0003", "currency": "USD", "generated_for_demo": true}')),
    ('INV_ES_004', 'INVOICE', '@SNOWFLAKE_EXAMPLE.SWIFTCLAW.DOCUMENT_STAGE', 'generated/invoice_es_004.pdf', 'invoice_es_004.pdf', 'PDF', 4800, 'es', 'PENDING',
     PARSE_JSON('{"vendor_name": "Servicios de Produccion Acme", "invoice_number": "INV-2024-0004", "currency": "USD", "generated_for_demo": true}')),
    -- German Invoice
    ('INV_DE_005', 'INVOICE', '@SNOWFLAKE_EXAMPLE.SWIFTCLAW.DOCUMENT_STAGE', 'generated/invoice_de_005.pdf', 'invoice_de_005.pdf', 'PDF', 4900, 'de', 'PENDING',
    ...
    -- Portuguese Invoice
    ('INV_PT_006', 'INVOICE', '@SNOWFLAKE_EXAMPLE.SWIFTCLAW.DOCUMENT_STAGE', 'generated/invoice_pt_006.pdf', 'invoice_pt_006.pdf', 'PDF', 5000, 'pt', 'PENDING',
     PARSE_JSON('{"vendor_name": "Servicos de Producao Acme", "invoice_number": "INV-2024-0006", "currency": "USD", "generated_for_demo": true}'));

SELECT '6 invoice documents cataloged' AS status;
...
VALUES
    ...
    ('ROY_EN_001', 'ROYALTY_STATEMENT', '@SNOWFLAKE_EXAMPLE.SWIFTCLAW.DOCUMENT_STAGE', 'generated/royalty_en_001.pdf', 'royalty_en_001.pdf', 'PDF', 5500, 'en', 'PENDING',
     PARSE_JSON('{"territory": "North America", "period": "Q3 2024", "currency": "USD", "generated_for_demo": true}')),
    ('ROY_EN_002', 'ROYALTY_STATEMENT', '@SNOWFLAKE_EXAMPLE.SWIFTCLAW.DOCUMENT_STAGE', 'generated/royalty_en_002.pdf', 'royalty_en_002.pdf', 'PDF', 5600, 'en', 'PENDING',
     PARSE_JSON('{"territory": "Europe", "period": "Q3 2024", "currency": "USD", "generated_for_demo": true}')),
    -- Spanish Royalty Statements
    ('ROY_ES_003', 'ROYALTY_STATEMENT', '@SNOWFLAKE_EXAMPLE.SWIFTCLAW.DOCUMENT_STAGE', 'generated/royalty_es_003.pdf', 'royalty_es_003.pdf', 'PDF', 5700, 'es', 'PENDING',
     PARSE_JSON('{"territory": "America Latina", "period": "Q3 2024", "currency": "USD", "generated_for_demo": true}')),
    ('ROY_ES_004', 'ROYALTY_STATEMENT', '@SNOWFLAKE_EXAMPLE.SWIFTCLAW.DOCUMENT_STAGE', 'generated/royalty_es_004.pdf', 'royalty_es_004.pdf', 'PDF', 5800, 'es', 'PENDING',
     PARSE_JSON('{"territory": "Europa", "period": "Q4 2024", "currency": "USD", "generated_for_demo": true}')),
    -- German Royalty Statement
    ('ROY_DE_005', 'ROYALTY_STATEMENT', '@SNOWFLAKE_EXAMPLE.SWIFTCLAW.DOCUMENT_STAGE', 'generated/royalty_de_005.pdf', 'royalty_de_005.pdf', 'PDF', 5900, 'de', 'PENDING',
     PARSE_JSON('{"territory": "Europa", "period": "Q3 2024", "currency": "USD", "generated_for_demo": true}')),
    -- Portuguese Royalty Statement
    ('ROY_PT_006', 'ROYALTY_STATEMENT', '@SNOWFLAKE_EXAMPLE.SWIFTCLAW.DOCUMENT_STAGE', 'generated/royalty_pt_006.pdf', 'royalty_pt_006.pdf', 'PDF', 6000, 'pt', 'PENDING',
     PARSE_JSON('{"territory": "America do Sul", "period": "Q4 2024", "currency": "USD", "generated_for_demo": true}'));

SELECT '6 royalty statement documents cataloged' AS status;
...
VALUES
    -- English Contracts
    ('CON_EN_001', 'CONTRACT', '@SNOWFLAKE_EXAMPLE.SWIFTCLAW.DOCUMENT_STAGE', 'generated/contract_en_001.pdf', 'contract_en_001.pdf', 'PDF', 7500, 'en', 'PENDING',
     PARSE_JSON('{"contract_type": "Licensing Agreement", "territory": "Worldwide", "currency": "USD", "generated_for_demo": true}')),
    ('CON_EN_002', 'CONTRACT', '@SNOWFLAKE_EXAMPLE.SWIFTCLAW.DOCUMENT_STAGE', 'generated/contract_en_002.pdf', 'contract_en_002.pdf', 'PDF', 7600, 'en', 'PENDING',
     PARSE_JSON('{"contract_type": "Distribution License", "territory": "North America", "currency": "USD", "generated_for_demo": true}')),
    -- Spanish Contracts
    ('CON_ES_003', 'CONTRACT', '@SNOWFLAKE_EXAMPLE.SWIFTCLAW.DOCUMENT_STAGE', 'generated/contract_es_003.pdf', 'contract_es_003.pdf', 'PDF', 7700, 'es', 'PENDING',
     PARSE_JSON('{"contract_type": "Acuerdo de Licencia", "territory": "America Latina", "currency": "USD", "generated_for_demo": true}')),
    ('CON_ES_004', 'CONTRACT', '@SNOWFLAKE_EXAMPLE.SWIFTCLAW.DOCUMENT_STAGE', 'generated/contract_es_004.pdf', 'contract_es_004.pdf', 'PDF', 7800, 'es', 'PENDING',
     PARSE_JSON('{"contract_type": "Licencia de Distribucion", "territory": "Europa", "currency": "USD", "generated_for_demo": true}')),
    -- German Contract
    ('CON_DE_005', 'CONTRACT', '@SNOWFLAKE_EXAMPLE.SWIFTCLAW.DOCUMENT_STAGE', 'generated/contract_de_005.pdf', 'contract_de_005.pdf', 'PDF', 7900, 'de', 'PENDING',
     PARSE_JSON('{"contract_type": "Lizenzvereinbarung", "territory": "Europa", "currency": "USD", "generated_for_demo": true}')),
    -- Portuguese Contract
    ('CON_PT_006', 'CONTRACT', '@SNOWFLAKE_EXAMPLE.SWIFTCLAW.DOCUMENT_STAGE', 'generated/contract_pt_006.pdf', 'contract_pt_006.pdf', 'PDF', 8000, 'pt', 'PENDING',
     PARSE_JSON('{"contract_type": "Contrato de Licenciamento", "territory": "America do Sul", "currency": "USD", "generated_for_demo": true}'));

SELECT '6 contract documents cataloged' AS status;
...
VALUES
    ...
    ('BRIDGE_EN', 'CONTRACT', '@SNOWFLAKE_EXAMPLE.SWIFTCLAW.DOCUMENT_STAGE', 'bridge_en.pdf', 'bridge_en.pdf', 'PDF', 15000, 'en', 'PENDING',
     PARSE_JSON('{"document_set": "bridge_translation_demo", "purpose": "Translation baseline (English)", "generated_for_demo": true}')),
    ('BRIDGE_ES', 'CONTRACT', '@SNOWFLAKE_EXAMPLE.SWIFTCLAW.DOCUMENT_STAGE', 'bridge_es.pdf', 'bridge_es.pdf', 'PDF', 15500, 'es', 'PENDING',
     PARSE_JSON('{"document_set": "bridge_translation_demo", "purpose": "Spanish translation demo", "generated_for_demo": true}')),
    ('BRIDGE_DE', 'CONTRACT', '@SNOWFLAKE_EXAMPLE.SWIFTCLAW.DOCUMENT_STAGE', 'bridge_de.pdf', 'bridge_de.pdf', 'PDF', 15200, 'de', 'PENDING',
     PARSE_JSON('{"document_set": "bridge_translation_demo", "purpose": "German translation demo", "generated_for_demo": true}')),
    ('BRIDGE_PT', 'CONTRACT', '@SNOWFLAKE_EXAMPLE.SWIFTCLAW.DOCUMENT_STAGE', 'bridge_pt.pdf', 'bridge_pt.pdf', 'PDF', 15300, 'pt', 'PENDING',
     PARSE_JSON('{"document_set": "bridge_translation_demo", "purpose": "Portuguese translation demo", "generated_for_demo": true}')),
    ('BRIDGE_RU', 'CONTRACT', '@SNOWFLAKE_EXAMPLE.SWIFTCLAW.DOCUMENT_STAGE', 'bridge_ru.pdf', 'bridge_ru.pdf', 'PDF', 16000, 'ru', 'PENDING',
     PARSE_JSON('{"document_set": "bridge_translation_demo", "purpose": "Russian translation demo", "generated_for_demo": true}')),
    ('BRIDGE_ZH', 'CONTRACT', '@SNOWFLAKE_EXAMPLE.SWIFTCLAW.DOCUMENT_STAGE', 'bridge_zh.pdf', 'bridge_zh.pdf', 'PDF', 14000, 'zh', 'PENDING',
     PARSE_JSON('{"document_set": "bridge_translation_demo", "purpose": "Chinese translation demo", "generated_for_demo": true}'));

SELECT '6 bridge translation demo documents cataloged' AS status;
...
SELECT 'Verifying documents on internal stage...' AS status;
