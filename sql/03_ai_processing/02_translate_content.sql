...
INSERT INTO SWIFTCLAW.STG_TRANSLATED_CONTENT (
    translation_id,
    parsed_id,
    source_language,
    target_language,
...
JOIN SWIFTCLAW.RAW_DOCUMENT_CATALOG catalog
...
SELECT
    ...
    CASE
        ...
        ELSE 'FAILED'
    END AS status
FROM SWIFTCLAW.STG_TRANSLATED_CONTENT trans
JOIN SWIFTCLAW.STG_PARSED_DOCUMENTS parsed ON trans.parsed_id = parsed.parsed_id;
